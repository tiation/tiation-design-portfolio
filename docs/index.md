---
layout: default
title: Mupan Leopard Wellness Hub - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Mupan Leopard Wellness Hub</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/mupan-leopard-wellness-hub" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t mupan-leopard-wellness-hub .

# Run container
docker run -p 8080:8080 mupan-leopard-wellness-hub
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/mupan-leopard-wellness-hub)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/mupan-leopard-wellness-hub/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/mupan-leopard-wellness-hub/discussions)
