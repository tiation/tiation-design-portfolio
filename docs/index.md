---
layout: default
title: Perth White Glove Magic - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Perth White Glove Magic</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/perth-white-glove-magic" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t perth-white-glove-magic .

# Run container
docker run -p 8080:8080 perth-white-glove-magic
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/perth-white-glove-magic)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/perth-white-glove-magic/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/perth-white-glove-magic/discussions)
